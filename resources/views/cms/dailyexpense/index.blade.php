@extends('cms.layout')
@section('title', 'عرض المصاريف اليومية')
@section('title2', 'عرض المصاريف اليومية')
@section('styles')
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title">عرض المصاريف اليومية</h4>
                    <p class="text-muted font-14 mb-3">
                        عرض المصاريف اليومية
                    </p>
                    <a href="{{ route('dailyexpenses.create') }}"
                        class="d-flex justify-content-center bg-info text-white p-1 d-block w-25 m-auto">اضافة مصروف
                        جديد</a>
                    ...
                    <form method="POST" action="{{ route('dailyexpenses.deleteByType') }}">
                        ...
                        <button type="submit" class="btn btn-success float-end mt-2">حذف كل المصروفات</button>
                    </form>
                    <div class="total mt-3 ">
                        <p class="mt-3">مجموع مبالغ المصروفات: <span class="bg-danger text-white p-1 ">{{ $totalAmount }} شيكل</span></p>
                    </div>
                </div>
            </div>
